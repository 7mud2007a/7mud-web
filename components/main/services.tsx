  ...
  return (
    <section id="services" className="py-20 px-4 md:px-8 max-w-6xl mx-auto scroll-mt-20">
      ...
      <motion.div
        ...
        whileHover={{ y: -4 }}
        className="glass-panel rounded-3xl p-6 sm:p-10 md:p-12 mb-16 relative overflow-hidden border border-white/90 shadow-xl hover:shadow-2xl transition-all duration-300"
      >
        {/* Subtle Background Accent Gradient */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-purple-200/50 via-sky-200/30 to-transparent blur-3xl pointer-events-none -z-10" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-emerald-200/40 via-sky-100/30 to-transparent blur-3xl pointer-events-none -z-10" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6 text-left">
            <div className="flex items-center gap-3">
              ...
              <div className="flex gap-1.5">
                <span className="px-2.5 py-0.5 rounded-full bg-purple-50 text-purple-700 text-xs font-semibold border border-purple-200/60">
                  Custom Design
                </span>
                <span className="px-2.5 py-0.5 rounded-full bg-sky-50 text-sky-700 text-xs font-semibold border border-sky-200/60">
                  Full Stack
                </span>
            ...
            <div>
              ...
              <p className="text-purple-700 font-semibold text-base sm:text-lg mt-2">
            ...
            {/* Price Box */}
            <div className="p-5 rounded-2xl bg-white/80 border border-slate-200/70 shadow-sm flex flex-col gap-1">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-500">
                STARTING FROM
              </span>
              <div className="flex items-baseline gap-2">
                <span className="text-4xl sm:text-5xl font-black bg-gradient-to-r from-purple-700 via-sky-600 to-emerald-600 bg-clip-text text-transparent">
                  $500+
                </span>
              </div>
          ...
          <div className="lg:col-span-6 glass-card p-6 sm:p-8 rounded-2xl border border-white/80 shadow-sm bg-white/60">
            <h4 className="text-base font-bold text-slate-800 uppercase tracking-wider mb-4 pb-3 border-b border-slate-200/60 flex items-center justify-between">
              <span>What The Service Includes</span>
              <span className="text-xs font-semibold text-purple-700 bg-purple-50 px-2.5 py-1 rounded-full border border-purple-200/50">
                Full Package
              </span>
            </h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {FEATURED_INCLUSIONS.map((item) => (
                <div key={item} className="flex items-start gap-2 text-xs sm:text-sm font-medium text-slate-700">
